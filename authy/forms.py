...
class EditProfileForm(forms.ModelForm):
    ...
    first_name = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'input is-medium'}), max_length=50, required=False)
    last_name = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'input is-medium'}), max_length=50, required=False)
    location = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'input is-medium'}), max_length=25, required=False)
    url = forms.URLField(widget=forms.TextInput(attrs={'class': 'input is-medium'}),
                         max_length=60, required=False)
    profile_info = forms.CharField(
        widget=forms.Textarea(attrs={'class': 'textarea is-primary'}), max_length=150, required=False)
